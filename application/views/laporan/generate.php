            ...
            <div id="content">
                ...
                <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Cetak Laporan Sales</h5>
                                <a href="<?=base_url('laporan/print_sales');?>" class="btn btn-primary">Cetak</a>
                            </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Cetak Laporan Data Sensor</h5>
                                <a href="<?=base_url('laporan/print_sensor');?>" class="btn btn-primary">Cetak</a>
                            </div>
                            </div>
                        </div>
                        </div>
